...
ggplot(temp, aes(fill=type, y=value, x=model)) + geom_bar(position = "dodge", stat = "identity") + theme_light(base_size = 9) + xlab("Model") + ylab("Value") + labs(fill = "Type") + scale_fill_brewer(palette="Paired") + theme(legend.position="bottom")
dev.off()
```
